...
sealed class TokenType(open val literal: String?) {
    ...
    object PlusColon : SizedTokenType("+:")
    object Minus : SizedTokenType("-")
    object DoubleMinus : SizedTokenType("--")
    object MinusColon : SizedTokenType("-:")
